...
var mergeProps = __name4(((slotProps, childProps) => {
...
__name4(concatAriaDescribedby, "concatAriaDescribedby");
var SlotContext = React3.createContext(mergeProps);
SlotContext.displayName = "SlotContext";
var SlotProvider = __name4(({ children, mergeProps: mergeProps2 }) => {
  return (0, import_jsx_runtime2.jsx)(SlotContext.Provider, { value: mergeProps2, children });
}, "SlotProvider");
function createSlot(ownerName) {
  const Slot2 = React3.forwardRef((props, forwardedRef) => {
    const context = React3.useContext(SlotContext);
...
//# sourceMappingURL=chunk-ELKU2PCT.js.map
